...
Seemed like it has improved as all 12 classrooms scored higher than the prior mean of 72.6. As the lowest score is 73. It shows an improvement across all classrooms in the sample.
...
The average score went up from 72.6 to like 75 which showed that scores had improved. 
...
Examine the chart you created, and suggest a better title based on the results of the data, not a description: New Reading Program Shown Consistent Gains Across Selected Classroom; title focuses on the results describing as the chart shows.
...
**Hypotheses:**
Null: The new reading program has not improved scores (null less or greater than 72.6)
Alternative: The new reading program it has improved scores (null greater than 72.6)
...
The new reading program is making a difference of the students performance as every classroom in our sample scored above the previous district.
