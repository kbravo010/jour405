...
The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
The charts show car thefts rising in 2023 before slightly dropping afterwards.
Car thefts soar in 2023 but remain to be spike levels in Prince George's County.
...
- **Null Hypothesis (H0)**: there is no difference in mean car thefts rates between pre spike and post spike.

- **Alternative Hypothesis (H1)**: One time period has a difference mean car theft from others.
...
There is a very low p-value between the three time periods. This suggest the spike in 2023 as the car theft has changed across periods.
...
Tukey's test shows a difference between all three periods whereas the theft rates during the spike year were much higher than before. As the difference of the pre and post spike is significant and remained to stay higher after 2023.

Headline: Car theft remains to uprise in Prince George's County after 2023 spike

Lede: In 2023, car thefts in Prince George's County remain at an all time higher before the spike, according to recent data.