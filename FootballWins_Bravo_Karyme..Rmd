...
It is useful because it explains the variations in wins and overall as the points scored matters the most. Additionally, the model gives a reasonable sense of what team success looks like.
...
The point scored has the strongest impact, takways has somewhat of an impact and gained does not seem impactful.

## Using the Model

Without using the words "multiple regression model", describe how you could use this model to cover a team or game.
I might be able to use this to show which stats might best predict a team's sucess and use those numbers for the results of the game.