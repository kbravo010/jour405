...
umd_fees |> 
    summarize(mean_2021_fees = mean(fall_2021),
            ...
            median_2024_fees = mean(fall_2024))
)
...
I found it interesting that UMD is spending money on athletic facilities where it requires to build these facilities as the fees remains the same, as they are very focused on doing that compared to other important things on campus such as recreation facilities, student stability, etc.
