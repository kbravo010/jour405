...
The education levels in the survey are often different because college educated people are very more likely to respond while those with a less education are not as interested and less likely to participate.
...
Voting intend to rises with education level, survey shows clear divide
...
The percentages for high school or lower grade levels are most after weighting, whereas college educational levels drop slightly.


2. Why might the weighted results be considered more accurate than the unweighted results?

Weighted results are more accurate because they adjust groups who are overrepresented or underrepresented in the sample.
...
The largest difference appear amongst repondents with high school level education or lower, are often underrepresented and gain more weight in the results.
...
It is important becayse weighting ensures that the poll results are more accurate when it represents the population. Without it, journalist could give misinformation on trends or exagerate opinions from overrpresented groups.


2. How might the differences between weighted and unweighted results affect how you would report on this data?

The weighted results can change the story's focus whereas unweighted result might overstate college-educated students.
...
I would like to know what is the demographic factor for where these responses are coming from. It can be gender, race, region, as I feel that would be a great asset to understanding more of this information and gives the readers a better understanding of the results.
