...
There is a slight decrease in auto stolen as the highest was 462 in October and a siginificant decrease in December of 386 within the span of two months. I do not think so, as what is happening now in the world with stolen vehicles, it is the most common crime in PG county. I believe the lower numbers does it difficult to summarize the data because of how little these crimes occur. Yes, it is a good sign that those numbers are low meaning those crimes occur less often, but it does make it difficult to write a good story about it unless we were comparing to previous years.
...
Examine the new dataframe, `pg_crime_averages`, by clicking on it in the Environment tab in RStudio. Write a couple of sentences describing the average number of incidents per for each category. Which categories have the highest average number of incidents per month? Which have the lowest? What does this tell you about the pattern of crime in Prince George's County? Are there categories that you have questions about? Why or why not?

The highest category is accident and the lowest is robbery residential as it does not have an answer meaning there is not enough information to determined what the average is. In PG County, we see a trend of theft within the area, whether it is a robbery, auto theft, or just theft itself which seems to be that trend. Yes, when realistically in a story where the data has the lowest but you want to write about it, does it make it more difficult to do so based on the minimal data given?
...
As said before, there is an ongoing trend happening with accidents that seem to be increasing overtime.
...
In Prince George's County, there has been a significant increase in the total number of accidents within the year.

There has been a total of 5776 accidents that had occurred within the year as December had been at its highest of 509 accidents since March which was at its lowest of 429. As the second highest crime in the county is auto vehicles stolen of 4790. There is an ongoing trend with the two highest crimes are in relation to vehicles that sparks concerns for the residents living in PG county.
