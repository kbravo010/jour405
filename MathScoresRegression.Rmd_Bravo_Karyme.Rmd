...
There is a clear negative relationship between the FARMS percentage and math test scores.
...
Model shows that there is a weak relationship because the FARMS percentage is linked to the math scores. Which it does not explain much on the variation and shows a downward trend that is not strong enough.
...
The largest difference is roughly between 20-30 percentage points off from what the model haf predicted. This can mean that some schools scored much more higher or even lower than what is expected.
...
This shows that the relations between the lower FARM rates and higher math scores, however, it is not strong enough to explain the entirety of the data. I would probably pitch a story highlighting schools that outperform one another and how the issue is much complicated than what the board members make it seem.
