...
The daily overdose call counts bounces around in a consistent range but does not stay in the long-term. As there are some days where nothing happens at all or things are more quieter.
...
There are some days that look high than before are the ones that are standardized. The outliers seem to stand out more and show the abnormal days.
...
That day stands out because it had more calls than a typical week they normally would get calls. It was busy compared to what an expected day would look like.
...
It shows a few days where overdose calls were above normal and could point out dangerous drug batches or holiday spikes. My next steps would be to check what led up to the event or go deeper into the dates or health officials. I might tell the editor the data I found and go deeper into the the patterns.
