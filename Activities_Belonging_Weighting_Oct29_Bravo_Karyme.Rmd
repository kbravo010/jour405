...
The range is about 0.23 to 3.04.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? 
When it has the weight of 0.23 means 23% of one person reduces their influence. Whereas, 3.04 is underrepresented which means their response counts for three people who did not respond to the survey.

3. Why might some respondents be weighted more heavily than others? Because it is underrepresented compared to the entire population. 

The weighting increases their influence which can have better results.
...
Rarely/never shows the biggest difference between weighted and unweighted because after weighting, the percentage of people who voted had decreased the most as it was overrepresented.

2. How might these differences affect reporting on likely voter turnout?
If a journalist were to use the unweighted results it gives inaccurate results. However, the weighting results would be more accurate due to a broader population.
...
It exists because people who are frequent in voting, they are most likely to respond to those surveys. Those voters would be considered overrepresented. Weighting can correct these imbalance so the results can become more better.
